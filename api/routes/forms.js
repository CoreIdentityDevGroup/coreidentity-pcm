...
router.patch('/:id/status', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
// ─── ADD NEW VERSION ──────────────────────────────────────────────────────────
router.post('/:id/versions', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.patch('/:id/parties/:party_id/sign', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.post('/:id/monitoring', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.patch('/:id/monitoring/:log_id/resolve', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.get('/monitoring/alerts', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
    const result = await db.forms.query(
