...
// removed. Referral-source management is a different domain from
// collecting and routing a specific client's package to legal -- not
// part of "collect and route only."

// GET /api/v1/referrers
router.get('/', authorize('facilitator','program_manager','intake_officer'), async (req, res) => {
...
router.post('/', authorize('facilitator','program_manager','intake_officer'), async (req, res) => {
...
router.patch('/:id', authorize('facilitator','program_manager','intake_officer'), async (req, res) => {
