...
// ─── ADD CONTACT ──────────────────────────────────────────────────────────────
router.post('/:id/contacts', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
// ─── UPDATE CONTACT ───────────────────────────────────────────────────────────
router.patch('/:id/contacts/:contact_id', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.post('/:id/banks', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
    const {
...
// ─── ADD DEAL LINK ────────────────────────────────────────────────────────────
router.post('/:id/deals', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
    const {
...
router.get('/:id/deals', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
...
router.patch('/:id/deals/:link_id', authorize('facilitator','program_manager','intake_officer'), async (req, res, next) => {
  try {
