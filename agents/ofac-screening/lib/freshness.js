...
const WARN_DAYS  = 4;
// HISTORICAL UAT OVERRIDE (removed 2026-09-17) -- raised from 7 to 14 on 2026-08-17. OFAC has not
...
const BLOCK_DAYS = 7; // Institutional release restores the documented baseline; publication age remains a limited signal.
